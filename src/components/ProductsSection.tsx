...
const products = [
  {
    ...
    description:
      "Comprehensive facility management with patient records, scheduling, billing, and analytics all in one platform.",
    icon: Building2,
    features: [
      "Patient Management",
  ...
  },
  {
    ...
    description:
      "Streamline client relationships, track interactions, and improve service delivery with intelligent insights.",
    icon: Users,
    features: [
      "Contact Management",
      "Lead Tracking",
  ...
  },
  {
    ...
    description:
      "Unify your business operations with integrated resource planning, inventory management, and financial controls.",
    icon: BarChart3,
    features: [
      "Resource Planning",
      "Inventory Control",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            Our suite of products is designed to meet the complex needs of
            modern businesses.
          </p>
        </motion.div>
